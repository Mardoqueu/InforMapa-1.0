...
public class MapaSorveteria extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setUpMapIfNeeded();
		Toast.makeText(this, "Sorveteria", Toast.LENGTH_SHORT).show();
...
*/
	...
	private class MarkerTask extends AsyncTask<Void, Void, String> {
		...
		private static final String SERVICE_URL = "http://pedreiras.esy.es/categorias/22.php";
