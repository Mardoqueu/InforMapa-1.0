...
public class SplashActivity extends Activity {
	...
	String RSSFEEDURL = "http://tribuna101.blogspot.com.br/feeds/posts/default?alt=rss";
	RSSFeed feed;
	String fileNameNoticias;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fileNameNoticias = "Noticias.td";

		File feedFile = getBaseContext().getFileStreamPath(fileNameNoticias);
		...
		if (conMgr.getActiveNetworkInfo() == null) {
			...
			if (!feedFile.exists()) {
				...
				Toast toast = Toast.makeText(this,
						...
						Toast.LENGTH_LONG);
				toast.show();
				feed = ReadFeed(fileNameNoticias);
	...
	private void WriteFeed(RSSFeed data) {
		...
		try {
			fOut = openFileOutput(fileNameNoticias, MODE_PRIVATE);
